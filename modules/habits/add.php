  ...
  <div class="page-container">
    ...
    <div class="habit-editor-layout">
      ...
      <div class="preview-column" style="width: 100%;">
        ...
        <div class="glass-card" id="habit-preview-card" style="display: flex; flex-direction: column; justify-content: space-between; border-left: 6px solid #06b6d4; padding: var(--space-md); transition: var(--transition-base);">
          
          <div style="display: flex; align-items: flex-start; justify-content: space-between; margin-bottom: var(--space-sm);">
            <div style="display: flex; gap: var(--space-md); align-items: center;">
              <div id="preview-icon-bg" style="background: rgba(6, 182, 212, 0.15); color: #06b6d4; width: 44px; height: 44px; border-radius: var(--radius-md); display: flex; align-items: center; justify-content: center; transition: var(--transition-base);">
                <i id="preview-icon" data-lucide="star" style="width: 24px; height: 24px;"></i>
              </div>
              <div>
                <h3 id="preview-name" style="font-size: var(--font-size-base); font-weight: 600; color: var(--color-dark); margin: 0;">New Habit</h3>
                <span id="preview-frequency" class="badge" style="font-size: 10px; background: rgba(0,0,0,0.05); padding: 2px 8px; border-radius: var(--radius-sm); text-transform: uppercase; font-weight: 700; margin-top: 4px; display: inline-block;">daily</span>
              </div>
            </div>
            <div style="position: relative; width: 52px; height: 52px;">
              <svg width="52" height="52" style="transform: rotate(-90deg);">
                <circle cx="26" cy="26" r="22" stroke="rgba(0,0,0,0.05)" stroke-width="4" fill="transparent" />
                <circle id="preview-circle" cx="26" cy="26" r="22" stroke="#06b6d4" stroke-width="4" stroke-linecap="round" fill="transparent" stroke-dasharray="138.23" stroke-dashoffset="138.23" style="transition: var(--transition-base);" />
              </svg>
          ...
          <p id="preview-description" class="text-muted" style="font-size: var(--font-size-sm); margin-top: var(--space-sm); margin-bottom: 0; opacity: 0.3; font-style: italic;">No description provided.</p>

        </div>
      </div>

      <!-- Add Form Column (Left on desktop) -->
          ...
          <form action="process.php" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" id="habit_name" name="habit_name" class="input-field" 
                     placeholder="e.g. Read 10 Pages" required maxlength="100" autofocus>
            </div>

            <div class="form-group">
              <label class="form-label" for="description">Description</label>
              <input type="text" id="description" name="description" class="input-field" 
                     placeholder="e.g. Before bed, no screens" maxlength="255">
            </div>
            ...
            <div style="display: flex; flex-direction: column; gap: var(--space-md); margin-bottom: var(--space-md);">
              ...
              <div class="form-group" style="margin-bottom: 0;">
                ...
                <input type="hidden" id="color" name="color" value="#06b6d4">
              ...
              <div class="form-group" style="margin-bottom: 0;">
                ...
                <input type="hidden" id="icon" name="icon" value="star">
            ...
            <button type="submit" class="btn btn-primary" style="width: 100%; margin-top: var(--space-md);">
              <i data-lucide="plus-circle"></i> Create Habit
            </button>
          </form>
        </div>
      </div>
