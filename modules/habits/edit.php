 ...
 * 
 * - Receives habit_id via GET: edit.php?id=123
...
<main class="main-content">
  <div class="page-container">
    <div class="page-header">
      <div><h1 class="page-title"><i data-lucide="pencil"></i> Edit Habit</h1></div>
      <a href="index.php" class="btn btn-ghost"><i data-lucide="arrow-left"></i> Back</a>
    </div>
    <div class="glass-card" style="max-width: 600px;">
      <p class="text-muted">Leader: Build the edit habit form here. Same fields as add.php but pre-filled.</p>
    </div>
  </div>
</main>
